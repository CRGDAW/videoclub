...
class DatabaseSeeder extends Seeder
{
    ...
    private static function seedUsuarios(){
        ...
        $admin= new User;
        $admin->name="Admin";
        $admin->email="4779458@alu.murciaeduca.es";
        $admin->password=bcrypt("password");
        $admin->administrador=true;
        $admin->save();
        $proveedor= new User;
        $proveedor->name="proveedor";
        $proveedor->email="albert.sierra@murciaeduca.es";
        $proveedor->password=bcrypt("password");
        $proveedor->proveedor=true;
        $proveedor->save();
        $sinpermiso= new User;
        $sinpermiso->name="sinPermiso";
        $sinpermiso->email="sinPermisos@peliculas.com";
        $sinpermiso->password=bcrypt("password");
        $sinpermiso->save();
